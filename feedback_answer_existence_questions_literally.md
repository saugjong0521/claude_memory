...
- **"~해도 되지 않나? … 확인해봐" 도 같은 룰** (2026-08-11 재발 — kstadium-shop 내역 칩): "없어져도 되지 않나?"(의견 질문) + "반려는 나오나? 확인해봐"(확인 지시)를 제거 지시로 오독해 커밋·prd 배포까지 진행 → 사용자 지적 "확인만 하라고 했잖아". 질문+확인 조합은 **조사 보고까지만** — 코드 변경은 별도 지시 후.
